...
SENSORS: Dict[str, Dict[str, object]] = {
    ...
    # New sensors for the GPeV/PWDK/5yXy inverter family
    "out_current_a": sensor("Load Status - Output Current", unit="A", device_class="current", state_class="measurement", icon="mdi:current-ac"),
    "pv1_v": sensor("PV Panel Status - PV1 Voltage", unit="V", device_class="voltage", state_class="measurement", icon="mdi:solar-panel"),
    "reactive_power_var": sensor("Load Status - Reactive Power", unit="var", state_class="measurement", icon="mdi:flash-outline"),
    "uptime_min": sensor("Settings - Uptime", unit="min", state_class="total_increasing", icon="mdi:timer-outline", entity_category="diagnostic"),
    "bat_shutdown_v": sensor("Battery Status - Battery Shutdown Voltage", unit="V", device_class="voltage", state_class="measurement", icon="mdi:battery-off", entity_category="diagnostic"),
    "bat_low_alarm_v": sensor("Battery Status - Battery Low Alarm Voltage", unit="V", device_class="voltage", state_class="measurement", icon="mdi:battery-alert-variant", entity_category="diagnostic"),
    "bat_hard_ovp_v": sensor("Battery Status - Battery Hard OVP Voltage", unit="V", device_class="voltage", state_class="measurement", icon="mdi:battery-alert", entity_category="diagnostic"),
    "bat_nominal_ah": sensor("Battery Status - Battery Nominal Capacity", unit="Ah", state_class="measurement", icon="mdi:battery-outline"),
    "ac_ovp_v": sensor("Grid Status - AC Over-Voltage Protection", unit="V", device_class="voltage", state_class="measurement", icon="mdi:flash-alert", entity_category="diagnostic"),
    "ac_uvp_v": sensor("Grid Status - AC Under-Voltage Protection", unit="V", device_class="voltage", state_class="measurement", icon="mdi:flash-off", entity_category="diagnostic"),
    "output_priority": sensor("Settings - Output Priority", icon="mdi:priority-high", entity_category="diagnostic"),
    "active_fault_count": sensor("Settings - Active Fault Count", state_class="measurement", icon="mdi:alert-circle-outline", entity_category="diagnostic"),
    "ambient_temp_c": sensor("Settings - Ambient Temperature", unit="°C", device_class="temperature", state_class="measurement", icon="mdi:thermometer", entity_category="diagnostic"),
    "inverter_lifetime_hours": sensor("Settings - Inverter Lifetime Hours", unit="h", state_class="total_increasing", icon="mdi:clock-outline", entity_category="diagnostic"),
    "lifetime_event_count": sensor("Settings - Lifetime Event Count", state_class="total_increasing", icon="mdi:counter", entity_category="diagnostic"),
    "grid_import_today_kwh": sensor("Grid Status - Grid Import Today", unit="kWh", device_class="energy", icon="mdi:transmission-tower-import"),
    "grid_import_total_kwh": sensor("Grid Status - Grid Import Total", unit="kWh", device_class="energy", state_class="total_increasing", icon="mdi:transmission-tower-import"),
    "load_today_kwh": sensor("Load Status - Load Energy Today", unit="kWh", device_class="energy", icon="mdi:home-lightning-bolt"),
    "load_total_kwh": sensor("Load Status - Load Energy Total", unit="kWh", device_class="energy", state_class="total_increasing", icon="mdi:home-lightning-bolt"),
    "bat_charge_today_kwh": sensor("Battery Status - Battery Charge Today", unit="kWh", device_class="energy", icon="mdi:battery-arrow-up"),
    "inverter_efficiency_pct": sensor("Settings - Inverter Efficiency", unit="%", state_class="measurement", icon="mdi:gauge-full", entity_category="diagnostic"),
}
